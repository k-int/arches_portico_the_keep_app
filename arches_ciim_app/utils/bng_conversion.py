def convert(grid_ref):
    ...
    grid_squares = {
        ...
        "SF": (0, 300), "SG": (100, 300), "SH": (200, 300), "SJ": (300, 300), "SK": (400, 300), "TF": (500, 300),
        "SL": (0, 200), "SM": (100, 200), "SN": (200, 200), "SO": (300, 200), "SP": (400, 200), "TL": (500, 200),
        "SQ": (0, 100), "SR": (100, 100), "SS": (200, 100), "ST": (300, 100), "SU": (400, 100), "TQ": (500, 100),
        "SV": (0, 0), "SW": (100, 0), "SX": (200, 0), "SY": (300, 0), "SZ": (400, 0), "TV": (500, 0),
    }  
